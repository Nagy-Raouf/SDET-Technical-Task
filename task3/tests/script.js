...
describe("Search Functionality Test", function () {
  ...
  it("Should search for 'dress' and verify results", function (browser) {
    ...
    // =========================================
    homePage.navigate();
    homePage.waitForElementVisible("@searchButton", 15000, "User is at the home page.");
    ...
    searchResultPage.waitForElementVisible("@searchKeyword", 15000, "The result page is loaded");
    ...
    searchResultPage.waitForElementVisible("@productList", 15000, "All the products are visible");
